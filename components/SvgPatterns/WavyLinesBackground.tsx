// components/SvgPatterns/WavyLinesBackground.tsx
import React from 'react';

const WavyLinesBackground = ({ className }: { className?: string }) => {
    return (
        <svg
            // Intrinsic SVG attributes
            width="2745"
            height="488"
            viewBox="0 0 2745 488"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            // Accessibility: Hide from screen readers as it's decorative
            aria-hidden="true"
            // Allow passing additional classes for positioning/sizing
            className={className}
        >
            {/* The actual path elements from the original HTML */}
            <path
                d="M0.5 330.864C232.505 403.801 853.749 527.683 1482.69 439.719C2111.63 351.756 2585.54 434.588 2743.87 487"
                className="stroke-neutral-700/50" // Style defined in the template
                stroke="currentColor"
            />
            <path
